...
namespace Elastos {
	namespace ElaWallet {
		...
		private:
			...
			const std::string TX_DATABASE_CREATE =
				"create table if not exists " + TX_TABLE_NAME + " (" + TX_COLUMN_ID +
				" text not null, " + TX_BUFF + " blob, " + TX_BLOCK_HEIGHT +
				" integer, " + TX_TIME_STAMP + " integer, " + TX_REMARK +
				" text DEFAULT '', " + TX_ASSETID + " text not null, " + TX_ISO +
				" text DEFAULT 'ELA' );";
		};
